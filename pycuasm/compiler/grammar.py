...
SASS_GRAMMARS = {    
    ...
    'FFMA'     : [
                  Grammar('x32', 0x5980000000000000, allow_pred = True, reg_store = True, rule = r"^$FFMA'f'z$rnd'sa' $r0, $r8, $fcr20, $r39"),
                  Grammar('x32', 0x5980000000000000, allow_pred = True, reg_store = True, rule = r"^$FFMA'f'z$rnd'sa' $r0, $r8, $r39s20, $c20s39"),
                ],
    ...
    'LEA'       : [
                   Grammar('cmp',  0x5bd0000000000000, allow_pred = True, reg_store = True, rule = r"^$LEA $p48, $r0cc, $r8, $icr20"),
    ...
    'LOP3'      : [
                   Grammar('x32',  0x5be7000000000000, allow_pred = True, reg_store = True, rule = r"^$LOP3\.LUT $r0, $r8, $r20, $r39, $i28w8"),
                   Grammar('x32',  0x3c00000000000000, allow_pred = True, reg_store = True, rule = r"^$LOP3\.LUT $r0, $r8, $i20, $r39, $i48w8"),
                 ],
    'POPC'      : [ Grammar('s2r',  0x5c08000000000000, allow_pred = True, reg_store = True, rule = r"^$POPC $r0, $r20") ],
    'SHF'       : [
                   Grammar('shft', 0x5bf8000000000000, allow_pred = True, reg_store = True, rule = r"^$SHF\.L$shf $r0, $r8, $ir20, $r39"),
                   Grammar('shft', 0x5cf8000000000000, allow_pred = True, reg_store = True, rule = r"^$SHF\.R$shf $r0, $r8, $ir20, $r39"),
                 ],
    ...
    'XMAD'      : [
                   Grammar('x32',  0x5b00000000000000, allow_pred = True, reg_store = True, rule = r"^$XMAD$xmad $r0cc, $r8, $ir20, $r39"),
                   Grammar('x32',  0x5900000000000000, allow_pred = True, reg_store = True, rule = r"^$XMAD$xmad $r0cc, $r8, $r39s20, $c20s39"),
                   Grammar('x32',  0x5e00000000000000, allow_pred = True, reg_store = True, rule = r"^$XMAD$xmadc $r0cc, $r8, $c20x, $r39"),
                 ],
    # XMAD replaces these
    ...
    'BRA'    : [
                Grammar('x32',0xe24000000000000f, allow_pred = True, reg_store = False, rule = r"^$BRA(?<U>\.U)? $i20w24"),
                Grammar('x32',0xe240000000000002, allow_pred = True, reg_store = False, rule = r"^$BRA(?<U>\.U)? CC\.EQ, $i20w24"),
              ],
    ...
    'DEPBAR' : [
                Grammar('gmem',0xf0f0000000000000, allow_pred = True, reg_store = False, rule = r"^$DEPBAR$icmp $dbar, $i20w6"),
                Grammar('gmem',0xf0f0000000000000, allow_pred = True, reg_store = False, rule = r"^$DEPBAR$dbar2"),
              ],
