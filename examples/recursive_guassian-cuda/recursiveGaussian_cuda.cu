...
#else
    d_recursiveGaussian_rgba<<< iDivUp(width, nthreads), nthreads, 3072 >>>(d_src, d_temp, width, height, a0, a1, a2, a3, b1, b2, coefp, coefn);
    //d_recursiveGaussian_rgba<<< iDivUp(width, nthreads), nthreads,  3328>>>(d_src, d_temp, width, height, a0, a1, a2, a3, b1, b2, coefp, coefn);
...
#else
    d_recursiveGaussian_rgba<<< iDivUp(height, nthreads), nthreads, 3072 >>>(d_dest, d_temp, height, width, a0, a1, a2, a3, b1, b2, coefp, coefn);
    //d_recursiveGaussian_rgba<<< iDivUp(height, nthreads), nthreads, 3328 >>>(d_dest, d_temp, height, width, a0, a1, a2, a3, b1, b2, coefp, coefn);
