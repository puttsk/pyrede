...
do
    ...
    do
        ...
        ./vptree $npoints $file 2>&1 | ${SCRIPT_DIR}collect.py ${TMP_DIR}${APP}_${TYPE}_${f}_unsorted.stats 2>&1 >> ${TMP_DIR}${APP}_${TYPE}_${f}_unsorted.out 
        ./vptree -s $npoints $file 2>&1 | ${SCRIPT_DIR}collect.py ${TMP_DIR}${APP}_${TYPE}_${f}_sorted.stats 2>&1 >> ${TMP_DIR}${APP}_${TYPE}_${f}_sorted.out
    done
